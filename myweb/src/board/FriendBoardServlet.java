...
@WebServlet("/friendboard")
public class FriendBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public FriendBoardServlet() {
        super();
    }

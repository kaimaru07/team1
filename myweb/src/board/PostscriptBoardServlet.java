...
@WebServlet("/postscriptboard")
public class PostscriptBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public PostscriptBoardServlet() {
        super();
    }
